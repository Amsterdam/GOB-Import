...
node {
    ...
    stage('Test') {
        tryStep "test", {
            ...
            sh "docker-compose -p gob_import_client -f jenkins/docker-compose.yml build && " +
               "docker-compose -p gob_import_client -f jenkins/docker-compose.yml run -u root --rm test"

        }, {
            sh "docker-compose -p gob_import_client -f jenkins/docker-compose.yml down"
        }
    }
